...
int main() {
    ...
    shared_ptr<dielectric> dielectricMat = make_shared<dielectric>(color{0.3,0.3,0.3},INDEX_DIAMOND);

    //terra
    //list.add(make_shared<sphere>(vec3{1.0,    0.0, -75.0},50.0,lambertMat));
    list.add(make_shared<sphere>(vec3{0.0,-100.5,-1.0},100.0,lambertMat));
    // //sfera
